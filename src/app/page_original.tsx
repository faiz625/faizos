...
//       {activeTab !== "home" && (
//         <div className="fixed top-0 left-0 right-0 z-40 bg-white/20 dark:bg-black/20 backdrop-blur-xl border-b border-gray-200 dark:border-white/10">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
//             <button 
//               onClick={() => openTab("home")} 
//               className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white hover:text-sky-600 dark:hover:text-sky-300 transition-colors"
//             >
//               Faiz
//             </button>
...
//               <div className="ml-4 flex items-center gap-2 border-l border-gray-300 dark:border-white/20 pl-4">
//                 <a 
//                   href="https://github.com/faiz625" 
//                   target="_blank" 
//                   rel="noopener noreferrer"
//                   className="p-2 rounded-lg hover:bg-black/10 dark:hover:bg-white/10 text-gray-700 dark:text-white/70 hover:text-gray-900 dark:hover:text-white transition-colors"
//                   title="GitHub"
//                 >
...
//                   </svg>
//                 </a>
//                 <div className="border-l border-gray-300 dark:border-white/20 pl-2 ml-2">
//                   <ThemeToggle />
//                 </div>
//               </div>
//             </div>
...
//               className="lg:hidden p-2 rounded-lg hover:bg-black/10 dark:hover:bg-white/10 text-gray-700 dark:text-white/80 hover:text-gray-900 dark:hover:text-white transition-colors"
...
//               </button>
//             </div>
//             <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-6 sm:mb-8 text-sky-600 dark:text-sky-300">Projects</h2>
...
//             <div className="mt-6 text-xs text-gray-500 dark:text-white/60">
...
//               </button>
//             </div>
//             <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-6 sm:mb-8 text-sky-600 dark:text-sky-300">Trading — Live Template</h2>
...
//               </button>
//             </div>
//             <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-6 sm:mb-8 text-sky-600 dark:text-sky-300">Photography — Visual Stories</h2>
...
//               <div>
//                 <h3 className="text-lg font-semibold mb-4 text-sky-600 dark:text-sky-300">Equipment & Style</h3>
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600 dark:text-white/80">
//                   <div>
//                     <h4 className="font-medium text-gray-800 dark:text-white mb-3">Current Setup</h4>
...
//                   </div>
//                   <div>
//                     <h4 className="font-medium text-gray-800 dark:text-white mb-3">Photography Style</h4>
//                     <ul className="space-y-1 text-sm">
...
//         {/* Contact Tab */}
//         {activeTab === "contact" && (
//           <div className="bg-black/5 dark:bg-white/5 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-white/10 p-8 max-w-4xl mx-auto">
//             <div className="flex items-center mb-6">
//               <button 
//                 onClick={() => openTab("home")} 
//                 className="flex items-center text-gray-600 dark:text-white/60 hover:text-sky-600 dark:hover:text-sky-300 transition-colors mr-4"
...
//               </button>
//             </div>
//             <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-6 sm:mb-8 text-sky-600 dark:text-sky-300">Contact — Email Faiz</h2>
//             <ContactForm />
//           </div>
//         )}
...
//               <h1 className="text-3xl sm:text-4xl md:text-6xl font-semibold tracking-tight mb-4 sm:mb-6 text-gray-900 dark:text-white">Faiz Kapadia</h1>
//               <p className="text-gray-600 dark:text-white/70 text-base sm:text-lg max-w-2xl mx-auto mb-4 px-4">
...
//                   target="_blank" 
//                   rel="noopener noreferrer"
//                   className="group flex items-center space-x-2 px-4 py-3 bg-black/10 dark:bg-white/10 backdrop-blur-xl rounded-lg hover:bg-black/15 dark:hover:bg-white/15 transition-all border border-gray-300 dark:border-white/10 hover:border-sky-300/30"
//                 >
//                   <svg className="w-5 h-5 text-sky-600 dark:text-sky-300 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
//                     <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.30 3.297-1.30.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
//                   </svg>
//                   <span className="text-gray-700 dark:text-white/80 font-medium">GitHub</span>
//                 </a>
...
//                     <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
//                   </svg>
//                   <span className="text-gray-700 dark:text-white/80 font-medium">LinkedIn</span>
//                 </a>
//               </div>
//             </div>
