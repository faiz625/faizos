...
export const AboutTab: React.FC<AboutTabProps> = ({ openTab }) => {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="bg-black/5 dark:bg-white/5 backdrop-blur-xl rounded-2xl border border-gray-200 dark:border-white/10 p-4 sm:p-8 animate-fade-in-scale overflow-hidden" style={{animationDelay: '0.2s'}}>
...
const HeroSection: React.FC = () => (
  <div className="bg-gradient-to-br from-black/10 via-sky-500/5 to-purple-500/10 dark:from-white/10 dark:via-sky-400/10 dark:to-purple-400/10 backdrop-blur-xl rounded-3xl border border-gray-200/50 dark:border-white/20 p-8 mb-8 relative group transition-all duration-500 hover:border-sky-400/40 dark:hover:border-sky-300/40 hover:shadow-2xl hover:shadow-sky-500/10">
    {/* Floating geometric shapes with enhanced animations */}
    <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-sky-400/20 to-purple-500/20 rounded-full animate-glow-pulse"></div>
    <div className="absolute -bottom-2 -left-2 w-12 h-12 bg-gradient-to-br from-purple-400/30 to-pink-500/30 rounded-full animate-bounce-gentle"></div>
    <div className="absolute top-1/2 -right-2 w-6 h-6 bg-gradient-to-br from-sky-300/40 to-cyan-400/40 rounded-full animate-pulse"></div>
    
    <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
      {/* Enhanced Avatar with multiple floating rings */}
      <div className="relative group/avatar animate-fade-in-scale" style={{animationDelay: '0.2s'}}>
        <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-br from-sky-400 via-purple-500 to-pink-500 p-1 animate-spin-slow">
          <div className="w-full h-full rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-4xl md:text-5xl font-bold text-sky-600 dark:text-sky-300 hover:scale-110 transition-transform duration-300">
            FK
          </div>
        </div>
        {/* Multiple floating rings with different animations */}
        <div className="absolute -inset-4 border-2 border-sky-400/30 rounded-full animate-glow-pulse"></div>
        <div className="absolute -inset-6 border border-purple-400/20 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
        <div className="absolute -inset-8 border border-pink-400/15 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
      </div>
      
      {/* Enhanced Hero Text */}
      <div className="text-center md:text-left animate-slide-in-right" style={{animationDelay: '0.4s'}}>
        <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-sky-600 via-purple-600 to-pink-600 dark:from-sky-300 dark:via-purple-300 dark:to-pink-300 bg-clip-text text-transparent mb-4 animate-gradient hover:scale-105 transition-transform duration-300">
          About Me
        </h2>
        <p className="text-lg md:text-xl text-gray-700 dark:text-white/80 mb-6 max-w-lg leading-relaxed animate-fade-in-scale" style={{animationDelay: '0.6s'}}>
        ...
        <div className="grid grid-cols-3 gap-4 max-w-md">
          <div className="bg-white/20 dark:bg-black/20 backdrop-blur-sm rounded-xl p-3 text-center border border-white/30 dark:border-white/10 hover:scale-110 transition-all duration-300 group/stat animate-slide-up overflow-hidden" style={{animationDelay: '0.8s'}}>
            ...
            <div className="relative z-10">
              <div className="text-2xl font-bold text-sky-600 dark:text-sky-300 animate-scale-pulse">5+</div>
              <div className="text-xs text-gray-600 dark:text-white/60">Years ML</div>
            </div>
          </div>
          <div className="bg-white/20 dark:bg-black/20 backdrop-blur-sm rounded-xl p-3 text-center border border-white/30 dark:border-white/10 hover:scale-110 transition-all duration-300 group/stat animate-slide-up overflow-hidden" style={{animationDelay: '1s'}}>
            ...
            <div className="relative z-10">
              <div className="text-2xl font-bold text-purple-600 dark:text-purple-300 animate-scale-pulse" style={{animationDelay: '0.2s'}}>20+</div>
              <div className="text-xs text-gray-600 dark:text-white/60">Projects</div>
            </div>
          </div>
          <div className="bg-white/20 dark:bg-black/20 backdrop-blur-sm rounded-xl p-3 text-center border border-white/30 dark:border-white/10 hover:scale-110 transition-all duration-300 group/stat animate-slide-up overflow-hidden" style={{animationDelay: '1.2s'}}>
            ...
            <div className="relative z-10">
              <div className="text-2xl font-bold text-pink-600 dark:text-pink-300 animate-scale-pulse" style={{animationDelay: '0.4s'}}>∞</div>
...
const PersonalInfo: React.FC = () => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
    <div className="bg-gradient-to-br from-sky-500/10 to-blue-500/10 rounded-xl p-6 border border-sky-500/20 hover-lift group animate-fade-in-scale overflow-hidden" style={{animationDelay: '0.1s'}}>
      ...
      <div className="relative z-10">
        <h3 className="text-xl font-semibold mb-4 text-sky-600 dark:text-sky-300 flex items-center animate-slide-in-right" style={{animationDelay: '0.2s'}}>
          <div className="w-8 h-8 bg-gradient-to-r from-sky-500 to-blue-500 rounded-lg flex items-center justify-center mr-3 group-hover:rotate-12 group-hover:scale-110 transition-all duration-300">
        ...
        <p className="text-gray-700 dark:text-white/90 leading-relaxed animate-fade-in-scale" style={{animationDelay: '0.3s'}}>
        ...
        <div className="mt-4 p-4 bg-white/20 dark:bg-black/20 rounded-lg border-l-4 border-sky-500 animate-slide-up hover:scale-105 transition-all duration-300 group/quote" style={{animationDelay: '0.4s'}}>
          ...
          <p className="text-lg font-bold bg-gradient-to-r from-sky-600 to-blue-600 dark:from-sky-300 dark:to-blue-300 bg-clip-text text-transparent italic relative z-10">
    ...
    <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-xl p-6 border border-purple-500/20 hover-lift group animate-fade-in-scale overflow-hidden" style={{animationDelay: '0.2s'}}>
      {/* Background shimmer effect */}
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -skew-x-12 transform translate-x-full group-hover:translate-x-[-200%] transition-transform duration-1000"></div>
      
      <div className="relative z-10">
        <h3 className="text-xl font-semibold mb-4 text-purple-600 dark:text-purple-300 flex items-center animate-slide-in-right" style={{animationDelay: '0.3s'}}>
          <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-3 group-hover:rotate-12 group-hover:scale-110 transition-all duration-300">
            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p className="text-gray-700 dark:text-white/90 leading-relaxed animate-fade-in-scale" style={{animationDelay: '0.4s'}}>
        ...
        <div className="mt-4 p-4 bg-white/20 dark:bg-black/20 rounded-lg border-l-4 border-purple-500 animate-slide-up hover:scale-105 transition-all duration-300 group/quote" style={{animationDelay: '0.5s'}}>
          ...
          <p className="text-lg font-bold bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-300 dark:to-pink-300 bg-clip-text text-transparent italic relative z-10">
...
const LanguagesSkillCard: React.FC<SkillCardProps> = ({ showAll, setShowAll }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-sky-500/10 to-purple-500/10 rounded-xl p-6 border border-sky-500/20 flex flex-col min-h-[300px] group hover:scale-[1.02] transition-all duration-300 animate-fade-in-scale overflow-hidden" style={{animationDelay: '0.1s'}}>
      {/* Background shimmer effect */}
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -skew-x-12 transform translate-x-full group-hover:translate-x-[-200%] transition-transform duration-1000"></div>
      ...
      <div className="relative z-10">
        <h4 className="font-semibold text-gray-800 dark:text-white mb-4 flex items-center animate-slide-in-right" style={{animationDelay: '0.2s'}}>
          <div className="w-6 h-6 bg-gradient-to-r from-sky-500 to-blue-500 rounded mr-3 group-hover:rotate-12 group-hover:scale-110 transition-all duration-300"></div>
            ...
            {languages.slice(0, showAll ? 7 : 5).map((lang, index) => (
              <div key={lang.name} className="flex items-center justify-between group/lang hover:scale-105 transition-all duration-300 animate-slide-up" style={{animationDelay: `${0.3 + index * 0.1}s`}}>
                <div className="flex items-center w-24">
                  <lang.icon className={`w-4 h-4 mr-2 ${lang.color} group-hover/lang:scale-110 transition-transform duration-300`} />
                ...
                <div className="flex-1 mx-4 bg-gray-200 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
                  <div 
                    className="bg-gradient-to-r from-sky-500 to-blue-500 h-2 rounded-full transition-all duration-2000 group-hover/lang:animate-pulse" 
                    style={{
                      width: `${lang.level}%`,
                ...
                <span className="text-xs text-gray-500 dark:text-white/60 min-w-[3rem] text-right font-mono">{lang.level}%</span>
              </div>
            ))}
          </div>
          <button 
            onClick={() => setShowAll(!showAll)}
            className="w-full mt-4 px-4 py-2 bg-white/20 dark:bg-black/20 hover:bg-white/30 dark:hover:bg-black/30 rounded-lg text-sm font-medium text-gray-700 dark:text-white/80 transition-all hover:scale-105 border border-sky-300/30 shimmer"
          >
...
const InterestsSection: React.FC = () => (
  <div>
    <h3 className="text-xl font-semibold mb-6 text-sky-600 dark:text-sky-300 flex items-center animate-fade-in-scale" style={{animationDelay: '0.1s'}}>
      <div className="w-8 h-8 bg-gradient-to-r from-pink-500 to-orange-500 rounded-lg flex items-center justify-center mr-3 animate-bounce-gentle hover:rotate-12 transition-transform duration-300">
        <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {[
        ...
        <div key={section.title} className={`bg-gradient-to-br ${section.gradient} rounded-xl p-6 border ${section.borderColor} hover-lift hover:scale-105 transition-all duration-300 group animate-fade-in-scale overflow-hidden`} style={{animationDelay: `${0.2 + index * 0.1}s`}}>
          {/* Background shimmer effect */}
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -skew-x-12 transform translate-x-full group-hover:translate-x-[-200%] transition-transform duration-1000"></div>
          
          <div className="relative z-10">
            <h4 className="font-semibold text-gray-800 dark:text-white mb-6 flex items-center animate-slide-in-right" style={{animationDelay: `${0.3 + index * 0.1}s`}}>
              <span className="text-2xl mr-3 group-hover:scale-125 group-hover:rotate-12 transition-all duration-300">{section.icon}</span>
              {section.title}
            </h4>
            <div className="space-y-4">
              {section.items.map((item, itemIndex) => (
                <div key={item.text} className="group/item bg-white/10 dark:bg-black/10 rounded-lg p-4 hover:bg-white/20 dark:hover:bg-black/20 transition-all duration-300 hover:scale-[1.02] cursor-pointer animate-slide-up overflow-hidden" style={{animationDelay: `${0.4 + index * 0.1 + itemIndex * 0.1}s`}}>
                  {/* Item background shimmer */}
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/3 to-transparent -skew-x-12 transform translate-x-full group-hover/item:translate-x-[-200%] transition-transform duration-1000"></div>
                  
                  <div className="flex items-start space-x-3 relative z-10">
                    <span className="text-xl group-hover/item:scale-125 group-hover/item:rotate-12 transition-all duration-300">{item.emoji}</span>
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-gray-500 dark:text-white/60 opacity-0 group-hover/item:opacity-100 transition-all duration-300 transform translate-y-2 group-hover/item:translate-y-0">
                        {item.desc}
                      </div>
                    </div>
                  </div>
...
const PhilosophySection: React.FC = () => (
  <div>
    <h3 className="text-xl font-semibold mb-6 text-sky-600 dark:text-sky-300 flex items-center animate-fade-in-scale" style={{animationDelay: '0.1s'}}>
      <div className="w-8 h-8 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center mr-3 animate-glow hover:rotate-12 hover:scale-110 transition-all duration-300">
        <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="relative bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 rounded-2xl p-8 border border-indigo-500/20 overflow-hidden group hover:scale-[1.02] transition-all duration-500 animate-fade-in-scale" style={{animationDelay: '0.2s'}}>
      {/* Multiple background patterns for enhanced effect */}
      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -skew-x-12 transform translate-x-full group-hover:translate-x-[-200%] transition-transform duration-1000"></div>
      <div className="absolute inset-0 bg-gradient-to-l from-transparent via-indigo-500/5 to-transparent -skew-x-12 transform -translate-x-full group-hover:translate-x-[200%] transition-transform duration-1500"></div>
      
      {/* Floating thought bubbles */}
      <div className="absolute top-4 right-4 w-3 h-3 bg-indigo-400/30 rounded-full animate-pulse"></div>
      <div className="absolute bottom-6 left-6 w-2 h-2 bg-purple-400/40 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
      <div className="absolute top-1/3 left-1/4 w-1 h-1 bg-pink-400/50 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
      
      {/* Content */}
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        <div className="text-4xl mb-4 opacity-20 dark:opacity-30 animate-bounce-gentle">💭</div>
        <blockquote className="text-lg text-gray-700 dark:text-white/90 leading-snug italic relative animate-slide-up px-8" style={{animationDelay: '0.3s'}}>
          <div className="absolute -left-6 -top-2 text-6xl text-indigo-500/30 font-serif animate-fade-in-scale" style={{animationDelay: '0.4s'}}>"</div>
          ...
          <div className="absolute -right-6 -bottom-2 text-6xl text-indigo-500/30 font-serif transform rotate-180 animate-fade-in-scale" style={{animationDelay: '0.6s'}}>"</div>
        </blockquote>
        <div className="mt-6 flex items-center justify-center animate-slide-up" style={{animationDelay: '0.7s'}}>
          <div className="w-12 h-0.5 bg-gradient-to-r from-indigo-500 to-purple-500 animate-gradient"></div>
          <span className="mx-4 text-sm text-gray-500 dark:text-white/60 font-medium bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-300 dark:to-purple-300 bg-clip-text text-transparent">
            Building AI that empowers, not replaces
          </span>
          <div className="w-12 h-0.5 bg-gradient-to-l from-indigo-500 to-purple-500 animate-gradient"></div>
        </div>
      </div>
    </div>
  </div>
...
const CTASection: React.FC<CTASectionProps> = ({ openTab }) => (
  <div className="pt-8 border-t border-gradient-to-r from-transparent via-gray-300 dark:via-white/20 to-transparent relative animate-slide-up" style={{animationDelay: '0.1s'}}>
    ...
    <div className="flex flex-col md:flex-row items-center justify-between">
      <div className="flex items-center space-x-4 mb-4 md:mb-0 animate-slide-in-right" style={{animationDelay: '0.2s'}}>
        <div className="w-10 h-10 bg-gradient-to-r from-sky-500 to-purple-500 rounded-full flex items-center justify-center hover:scale-110 hover:rotate-12 transition-all duration-300 animate-glow-pulse">
          <span className="text-white font-bold text-sm">FK</span>
        </div>
        <div>
          <p className="text-gray-700 dark:text-white/80 font-medium animate-fade-in-scale" style={{animationDelay: '0.3s'}}>Ready to collaborate?</p>
          <p className="text-gray-500 dark:text-white/60 text-sm animate-fade-in-scale" style={{animationDelay: '0.4s'}}>Explore my projects, try the demos, or check out my photography.</p>
        </div>
      </div>
      <div className="flex space-x-3 animate-slide-in-right" style={{animationDelay: '0.5s'}}>
        <button 
          onClick={() => openTab("projects")} 
          className="px-4 py-2 bg-sky-500 hover:bg-sky-600 text-white rounded-lg text-sm font-medium transition-all hover:scale-105 shadow-lg shimmer hover:shadow-sky-500/25 animate-glow-pulse"
        >
          View Projects
        </button>
        <button 
          onClick={() => openTab("contact")} 
          className="px-4 py-2 bg-white/10 dark:bg-black/20 hover:bg-white/20 dark:hover:bg-black/30 text-gray-700 dark:text-white rounded-lg text-sm font-medium transition-all hover:scale-105 border border-gray-200 dark:border-white/10 shimmer"
        >
          Get in Touch
        </button>
      </div>
